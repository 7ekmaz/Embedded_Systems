...
void MCAL_STK_Init(u32 Copy_Ticks)  //copy_ticks ---> time in micro seconds
{
...
Std_ReturnType MCAL_STK_SetDelay_ms(f32 Copy_Milliseconds)                         //to do a Delay>>>>EASY AS FUCK
{
